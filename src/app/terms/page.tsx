      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="mb-10">
          ...
          <p className="mt-4 text-white/70">
            These Terms & Conditions govern the use of Created.ai and the services provided by
        ...
        <div className="space-y-8 text-white/70 leading-relaxed">
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-3">
              Created.ai provides businesses and agencies with tools to connect Meta assets, manage ad
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-3">
              You are responsible for ensuring that your use of Created.ai complies with Meta
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-3">
              Created.ai is provided on an "as is" and "as available" basis. ContentCreator Ai, LLC
